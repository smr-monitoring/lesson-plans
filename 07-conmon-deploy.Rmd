...
* **Informal homework for next week:** Each person in your group should stop by your monitoring station at least once between now and next Thursday to make sure everything looks ok. 
...
1. [Look up tides](https://www.tide-forecast.com/locations/Saint-Marys-City-Maryland/tides/latest) for today and next Thursday. Look at the tidal range for our location. What's the minimum depth we should deploy in, given the predicted tidal stage for this afternoon, to ensure the sensors stay underwater?
...
1. Program light loggers to log at 15-minute intervals starting at 13:00 today.
