...
* Sign up for skills assessment time slot [here](https://docs.google.com/spreadsheets/d/1hLHxzoFL6l4t2Bhw_rAb9f7xipIo0W3GSJmhjz17Hp8/edit?gid=0#gid=0)
* We will meet in the River Center lab next week for the skills assessment.
* Final exam is Thursday 12/12 9:00-11:15 in this room (SH116). It will be multiple choice, based on the learning objectives listed on the weekly class pages.
...
2.  Program a continuous data logger (light/temperature) and prepare for deployment (attach logger, line, and buoy to block using proper knots: bowline and lobster buoy hitch)

3. Filter water samples for chl *a* and TSS
...
5. Properly secure a boat using a cleat hitch
